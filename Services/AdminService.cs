...
public class AdminService
{
    ...
    public AdminService()
    {
        _claims.Add(new DamageReport { 
            ...
            Latitude = 6.9016, Longitude = 79.8659, DamageRate = 6.5
        });
        _claims.Add(new DamageReport { 
            ...
            Latitude = 7.0840, Longitude = 79.9939, DamageRate = 4.2
        });
        _claims.Add(new DamageReport { 
            ...
            Latitude = 6.5854, Longitude = 79.9607, DamageRate = 2.1
        });
        _claims.Add(new DamageReport { 
            ...
            Latitude = 6.9427, Longitude = 79.9825, DamageRate = 0.5
        });
        _claims.Add(new DamageReport { 
            ...
            Latitude = 6.9044, Longitude = 79.9631, DamageRate = 5.8
        });
    }
